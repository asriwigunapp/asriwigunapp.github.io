  ...
  <header class="d-print-none">
    <div class="container text-center text-lg-left">
      <div class="pt-4 clearfix">
        <h1 class="site-title mb-0">Asri Wiguna Pramesti</h1>
        <div class="site-nav">
          <nav role="navigation">
    ...
    <div class="container">
      <div class="resume-container">
            ...
            <div class="cover bg-image"><img src="assets/images/header-background.jpg" />
              <div class="mask" style="background-color: rgba(0, 0, 0, 0.7);backdrop-filter: blur(2px);">
                <div class="text-center p-5">
                  <div class="avatar p-1"><img class="img-thumbnail shadow-2-strong" src="assets/images/avatar.png" width="150" height="150" /></div>
                  <div class="header-bio mt-3">
                    <div data-aos="zoom-in" data-aos-delay="0">
                      <h2 class="h1">Asri Wiguna Pramesti</h2>
                      <p>Graphic Design and Video Editor</p>
                    </div>
                    <div class="header-social mb-3 d-print-none" data-aos="zoom-in" data-aos-delay="200">
                      <nav role="navigation">
                        <ul class="nav justify-content-center">
                          <li class="nav-item"><a class="nav-link" href="https://www.facebook.com/profile.php?id=100073183745743" title="Facebook"><i class="fab fa-facebook"></i><span class="menu-title sr-only">Facebook</span></a>
                          </li>
                          <li class="nav-item"><a class="nav-link" href="https://www.instagram.com/asriwigunapp/" title="Instagram"><i class="fab fa-instagram"></i><span class="menu-title sr-only">Instagram</span></a>
                          </li>
                          <li class="nav-item"><a class="nav-link" href="https://github.com/asriwigunapp" title="Github"><i class="fab fa-github"></i><span class="menu-title sr-only">Github</span></a>
                          </li>
                        </ul>
                      </nav>
                    </div>
          ...
          <div class="about-section">
            <div class="row">
              <div class="col-md-6">
                ...
                <p>Mahasiswa Teknik Informatika semester 4 di Universitas Muhammadiyah Sukabumi yang energetik dan pantang menyerah.
                  Aktif dalam keanggotaan organisasi kampus. Memiliki kemampuan untuk berkomunikasi yang baik dan memiliki ketertarikan besar dalam dunia digital.</p>
              </div>
        ...
        <footer class="pt-4 pb-4 text-muted text-center d-print-none">
          <div class="container">
            <div class="my-3">
              <div class="h4">Asri Wiguna Pramesti</div>
